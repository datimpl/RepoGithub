import { createActionSet, createPaginationActionSet } from '../../utils/action-helper';

export const ACTIVITY_GET_EVENTS_RECEIVED = createPaginationActionSet('ACTIVITY_GET_EVENTS_RECEIVED');
export const ACTIVITY_GET_STARRED_REPOS_FOR_USER = createPaginationActionSet('ACTIVITY_GET_STARRED_REPOS_FOR_USER');
...
export const REPOS_GET_CONTRIBUTORS = createPaginationActionSet('REPOS_GET_CONTRIBUTORS');
export const REPOS_FORK = createActionSet('REPOS_FORK');
export const REPOS_GET_ISSUE = createActionSet('REPOS_GET_ISSUE');
export const REPOS_GET_ISSUE_TIMELINE = createPaginationActionSet('REPOS_GET_ISSUE_TIMELINE');
